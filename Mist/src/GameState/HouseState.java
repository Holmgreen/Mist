...
public abstract class HouseState extends GameState {
    //This is a game state with only one entrance, special is that you cant attack inside the house.
	...
	if (ooru.getCurrentRow() == starty / map.getTileSize() && ooru.getCurrentCol() == startx / map.getTileSize()) {
