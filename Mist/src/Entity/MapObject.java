...
public abstract class MapObject {
    ...
    protected double initMoveSpeed;
    ...
    //Gustav: This only works if the player size is greater than tile size (?)
	...
	if (facingRight) {
	    ...
	    g.drawImage(
	    animation.getImage(), (int) (x + xmap - width / 2 + width), (int) (y + ymap - height / 2), -width, height, null);
	}
